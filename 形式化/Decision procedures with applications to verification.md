...
检查
$x=y \wedge x=z$
这种变体是否正确？证明其正确性或给出反例。
2. 展示一个示例，其中上述变体减少了Deduction和SAT求解器之间的迭代次数。

  

**问题3.3** （理论传播）。设$DPT$是用于$\Sigma$-文字合取的决策过程。建议一个使用$DPT$执行穷尽理论传播的过程。
