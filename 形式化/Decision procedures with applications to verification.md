...
$s_1$ 的下界为2，被违反。顺序中最低的非基本变量是 $x$。变量 $x$ 有正系数，但没有上界，因此适合枢轴操作。我们需要增加 $s_1$ 到2 以满足下界，这意味着 $x$ 也需要增加2（$\theta = 2$）。枢轴操作的第一步是解 $s_1$ 的行关于 $x$ 的方程：
...
\begin{array}{cc}
s_1 \quad s_3 \\
x & \frac{2}{3} \quad -\frac{1}{3} \\
s_2 & 1 \quad -1 \\
y & \frac{1}{3} \quad \frac{1}{3} \\
\end{array}
$$
